  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        {Array.isArray(record.vehicles_data) && record.vehicles_data.some((v: any) => v.camera_extra_quantity > 0) && (
          <div>
            <h3 className="font-semibold mb-3 flex items-center gap-2">
            ...
            <div className="rounded-md border">
              <Table>
                ...
                <TableBody>
                  {record.vehicles_data.filter((v: any) => v.camera_extra_quantity > 0).map((v: any, idx: number) => (
                    <TableRow key={idx}>
